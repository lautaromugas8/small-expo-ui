const discoverData = [
  ...
  },
  {
    ...
    description:
      "Great day hikes and backpacking routes on the North and South Rin of this century-old national park include easy hikes overlooking the rin and more rugged trekking options that descend into the canyon.",
    liked: true,
    price: 350,
    rating: 4.5,
    duration: 3,
